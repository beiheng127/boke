...
-- 正在导出表  boke.articles 的数据：~14 rows (大约)
...
-- 正在导出表  boke.article_likes 的数据：~7 rows (大约)
...
-- 正在导出表  boke.comments 的数据：~10 rows (大约)
...
INSERT INTO `conversations` (`id`, `user1_id`, `user2_id`, `last_message_id`, `last_message_content`, `last_message_at`, `unread_count_user1`, `unread_count_user2`, `created_at`, `updated_at`) VALUES
	...
	(6, 1, 9, 27, '66', '2025-12-19 01:57:30', 0, 0, '2025-11-25 00:55:14', '2025-12-19 02:04:02'),
...
-- 正在导出表  boke.favorites 的数据：~8 rows (大约)
...
-- 正在导出表  boke.follows 的数据：~10 rows (大约)
...
-- 正在导出表  boke.messages 的数据：~26 rows (大约)
...
INSERT INTO `users` (`id`, `username`, `password_hash`, `role`, `display_name`, `avatar_url`, `signature`, `created_at`, `home_background_url`, `email`) VALUES
	(1, 'admin', '$2a$10$UEWh8qTE9PGJZwBBolediunalruC9HZZ.NwVHdOJ4GL932Aaia3aa', 'BLOGGER', '北恒', '/uploads/images/2025-11-14/ce796a9943614a4da46b6fdf327eb120.jpg', '北恒的北是北方的北', '2025-11-11 21:35:31', '/uploads/images/2025-11-18/5d0d7a3cf89543b290c4452eb24767f4.jpg', '934705339@qq.com'),
	...
	(9, 'bhy', '$2a$10$PDDZX.wrBouM5EnZ8vaXWOffnYtmnHT/xMrZnSkJ1mzkmew5PnDdC', 'VIEWER', '北恒吖', '/uploads/images/2025-12-19/bacb26b0935f4378ba9f4908b7f6e589.jpg', '飞龙在天', '2025-11-16 10:11:44', NULL, 'ruia36791@163.com'),
